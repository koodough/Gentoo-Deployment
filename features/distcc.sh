...
gentoo_commander make_config	"FEATURES=\"\${FEATURES} distcc\""
gentoo_commander post_message	"Distcc: Change MAKEOPTS=\"-jN\" in make.conf to the number of (distcc servers) x2 + 2. Example: 10 cores is MAKEOPTS=\"-j22\""
