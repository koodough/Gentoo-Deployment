...
read -p "Memory limit for portage (500M): " $portage;
portage=${portage:-"500M"}
gentoo_commander pre_install "echo \"tmpfs /var/tmp/portage tmpfs size=$portage 0 0\" >> /etc/fstab"
